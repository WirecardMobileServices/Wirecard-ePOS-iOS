...
/**
 @brief Unzip the archive into the specified path
 @param filePath file to unzip
 @param path path to unzip files into
 @param deleteOriginalFile if original archive file should be deleted
 @return true if success
 */
+(BOOL)unzip:(NSString *)filePath toPath:(NSString*)path deletingOriginalFile:(BOOL)deleteOriginalFile;
