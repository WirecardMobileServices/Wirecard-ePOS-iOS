...
@class WDSaleRequest, WDSaleCore, WDReferenceSaleRequest, WDSale, WDSaleResponse, WDSaleMaintain;
...
/**
 *  @class WDFileDownload
 *  @brief Downloaded file information
 **/
@interface WDFileDownload : NSObject
/**
 */
...
/**
 */
@property (nonatomic, strong) NSString * _Nullable fileContentType;
@end
 ...
 *  @param paymentMethods Payment Methods to query for
 ...
 *  @param statuses Sale Statuses to query for
 *  @param saleTypes Sale Types to query for
 *  @param supportedPaymentTypes Supported Payment Types - as Payment Method + Transaction Type 
 *  @return new Sales Query
 **/
-(instancetype)initWithPage:(NSUInteger)page
                   pageSize:(NSUInteger)pageSize
                  ...
                  orderSort:(WDQuerySort)orderSort
                   statuses:(NSArray <NSNumber*>*)statuses
                  saleTypes:(NSArray <NSNumber*>*)saleTypes
			 supportedPaymentTypes:(NSArray <NSNumber*>*)supportedPaymentTypes;
/**
...
/**
 * @brief transactionTypes is an array of one or many of WDSupportedPaymentType - to restrict payment method to Card Purchases or Card Authorization for example
 */
@property (nonatomic, strong) NSArray <NSNumber*>*  _Nullable supportedPaymentTypes;
/**
 */
...
@property (nullable, nonatomic, strong) NSString *name;
@property (nullable, nonatomic, strong) NSString *notifyCallbackFormat;
...
/**
 *  @typedef FileCategoriesCompletion
 *  @brief Callback after the list of files was retrieved from backend
 *  @param files Files list
 **/
typedef void(^FileFilesCompletion)(NSArray <WDFile *> * _Nullable files, NSError * _Nullable error);
 ...
 *  @param file  files
 **/
typedef void (^FileDownloadCompletion)(WDFileDownload * _Nullable file, NSError * _Nullable error);
